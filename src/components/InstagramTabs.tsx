  ...
  return (
    <Tabs defaultValue="grid" className="w-full">
      <TabsList className={`grid grid-cols-3 border-t ${borderColor} ${theme === 'dark' ? 'bg-[#121212]' : 'bg-white'}`}>
        <TabsTrigger value="grid" className="flex justify-center py-3 data-[state=active]:border-b-2 data-[state=active]:border-b-black dark:data-[state=active]:border-b-white rounded-none">
          <Grid2x2 size={24} />
        </TabsTrigger>
        <TabsTrigger value="reels" className="flex justify-center py-3 data-[state=active]:border-b-2 data-[state=active]:border-b-black dark:data-[state=active]:border-b-white rounded-none">
        ...
        <TabsTrigger value="tagged" className="flex justify-center py-3 data-[state=active]:border-b-2 data-[state=active]:border-b-black dark:data-[state=active]:border-b-white rounded-none">
